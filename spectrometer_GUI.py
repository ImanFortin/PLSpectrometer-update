...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.box4.setGeometry(QtCore.QRect(10, 420, 241, 161))
        self.box4.setFrameShape(QtWidgets.QFrame.Box)
        self.box4.setLineWidth(3)
        self.box4.setText("")
        ...
        self.box3.setGeometry(QtCore.QRect(10, 280, 241, 131))
        self.box3.setFrameShape(QtWidgets.QFrame.Box)
        self.box3.setLineWidth(3)
        self.box3.setText("")
        ...
        self.move_input = QtWidgets.QLabel(self.centralwidget)
        self.move_input.setGeometry(QtCore.QRect(20, 310, 71, 21))
        self.move_input.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.move_input.setFrameShape(QtWidgets.QFrame.Panel)
        self.move_input.setFrameShadow(QtWidgets.QFrame.Plain)
        self.move_input.setObjectName("move_input")
        self.box2 = QtWidgets.QLabel(self.centralwidget)
        self.box2.setGeometry(QtCore.QRect(10, 140, 241, 131))
        self.box2.setFrameShape(QtWidgets.QFrame.Box)
        self.box2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.box2.setLineWidth(3)
        self.box2.setText("")
        self.box2.setObjectName("box2")
        self.recalibrate_input = QtWidgets.QLabel(self.centralwidget)
        self.recalibrate_input.setGeometry(QtCore.QRect(20, 170, 71, 21))
        self.recalibrate_input.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.recalibrate_input.setFrameShape(QtWidgets.QFrame.Panel)
        self.recalibrate_input.setFrameShadow(QtWidgets.QFrame.Plain)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.move_input.setText(_translate("MainWindow", "TextLabel"))
        self.recalibrate_input.setText(_translate("MainWindow", "TextLabel"))
