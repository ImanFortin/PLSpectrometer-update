...
"}")
        ...
        self.frame2.setGeometry(QtCore.QRect(10, 300, 401, 91))
...
"}")
        ...
        self.frame3.setGeometry(QtCore.QRect(10, 430, 401, 91))
...
"}")
        ...
        self.progressBar_scan.setOrientation(QtCore.Qt.Horizontal)
        self.progressBar_scan.setInvertedAppearance(False)
        ...
        self.move_spectrometer_lbl.setGeometry(QtCore.QRect(10, 400, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
